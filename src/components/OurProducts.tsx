    ...
    <div className="w-full h-[300px] flex justify-center items-center mt-16">
      <div className="w-[80%] h-full">
        ...
        <div className="sm:pl-5 md:pl-0">
          ...
          <span className="ml-2 text-red-500 text-sm font-bold">Our Products</span>
          <div className="flex">
        ...
        {/* button */}
        <button className="py-2 px-3 bg-red-500 text-white ml-[467px] mt-8 rounded-md">View All Products</button>
      </div>
    </div>
